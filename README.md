...
### Opening Xcode Project workspace through Terminal.app (if preferred)
1. Launch Terminal.app
2. Navigate (`cd`) to `StorybookPackager` project root directory
3. Run the command `open Storybook\ Packager.xcworkspace`
